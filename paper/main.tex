...
\author{\IEEEauthorblockN{Brando Mattivi}
...
\nextgroupplot[title={(d) uncertainty weighting $s_k$}, ylabel={$s_k$}, ymin=-2.8, ymax=3.6, legend columns=2, legend pos=north, legend style={font=\scriptsize}]
